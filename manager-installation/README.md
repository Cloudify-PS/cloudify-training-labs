...
```bash
curl -J -O http://repository.cloudifysource.org/cloudify/4.5.5/ga-release/cloudify-manager-install-4.5.5ga.rpm
```

### Step 2: Install Cloudify Manager's RPM

```bash
sudo yum -y install cloudify-manager-install-4.5.5ga.rpm
```
...
![Cloudify 4.5.5 Login](../../../raw/4.5.5/manager-installation/cfy-ui-login.png "Cloudify UI: Login")
