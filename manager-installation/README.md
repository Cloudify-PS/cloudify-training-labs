...
```bash
curl -J -O http://repository.cloudifysource.org/cloudify/4.6.0/ga-release/cloudify-manager-install-4.6ga.rpm
```

### Step 2: Install Cloudify Manager's RPM

```bash
sudo yum -y install cloudify-manager-install-4.6ga.rpm
```
...
![Cloudify 4.6.0 Login](../../../raw/4.6/manager-installation/cfy-ui-login.png "Cloudify UI: Login")
