...
The [Cloudify Manager prerequisites page](https://docs.cloudify.co/4.6/install_maintain/installation/prerequisites/) describes a few
...
* A security group that allows access to agents, as specified in the [Agent prerequisites description](https://docs.cloudify.co/4.6/install_maintain/agents/).
...
The official Cloudify Manager image is located at: http://repository.cloudifysource.org/cloudify/4.6.0/ga-release/cloudify-manager-4.6ga.qcow2
