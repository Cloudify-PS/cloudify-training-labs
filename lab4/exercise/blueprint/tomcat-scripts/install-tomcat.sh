...
newPort=REPLACE_WITH_A_COMMAND_THAT_RETRIEVES_THE_TOMCAT_PORT_VIA_THE_OPERATION_CONTEXT
REPLACE_WITH_A_COMMAND_THAT_WRITES_THE_TOMCAT_PORT_TO_THE_LOG_VIA_THE_OPERATION_CONTEXT
...
REPLACE_WITH_A_COMMAND_THAT_STORES_THE_APPLICATION_URL_IN_THE_RUNTIME_PROPERTIES_OF_THE_INSTANCE_VIA_THE_OPERATION_CONTEXT
