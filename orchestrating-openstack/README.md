...
For the preparation of this lab, you will have to use the official OpenStack plugin documentation, located at: https://docs.cloudify.co/4.3.0/working_with/official_plugins/openstack/
