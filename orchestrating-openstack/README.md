...
For the preparation of this lab, you will have to use the official OpenStack plugin documentation, located at: https://docs.cloudify.co/4.6/working_with/official_plugins/infrastructure/openstack/
...
*   The subnet needs to have a "leg" in the router. To achieve that: https://docs.cloudify.co/4.6/working_with/official_plugins/infrastructure/openstack/#cloudify.openstack.subnet_connected_to_router
...
*   You can use any flavour. Since Horizon doesn't provide the functionality of viewing flavour ID's unless you're an administrator,
    ...
    nova flavor-list
    ```
*   The server needs to be connected to the security group. To achieve that: https://docs.cloudify.co/4.6/working_with/official_plugins/infrastructure/openstack/#cloudify.openstack.server_connected_to_security_group
