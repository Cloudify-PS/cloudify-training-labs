...
(Reference: http://docs.getcloudify.org/4.1/blueprints/spec-dsl-definitions/)
...
Documentation: http://docs.getcloudify.org/4.1/plugins/openstack/#cloudify-openstack-nodes-network
...
Documentation: http://docs.getcloudify.org/4.1/plugins/openstack/#cloudify-openstack-nodes-router
...
Documentation: http://docs.getcloudify.org/4.1/plugins/openstack/#cloudify-openstack-nodes-subnet
...
Documentation: http://docs.getcloudify.org/4.1/plugins/openstack/#cloudify-openstack-nodes-securitygroup

We need only one rule: allow ingress traffic on port 22, from anywhere.

### Add a keypair

Documentation: http://docs.getcloudify.org/4.1/plugins/openstack/#cloudify-openstack-nodes-keypair
...
Documentation: http://docs.getcloudify.org/4.1/plugins/openstack/#cloudify-openstack-nodes-server
...
*   The server needs to be connected to the security group. To achieve that: http://docs.getcloudify.org/4.1/plugins/openstack/#cloudify-openstack-server-connected-to-security-group
