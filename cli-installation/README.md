...
```bash
curl -J -O http://cloudify-release-eu.s3.amazonaws.com/cloudify/4.3.2/ga-release/cloudify-cli-4.3.2~ga.el6.x86_64.rpm
sudo yum install -y cloudify-cli-4.3.2~ga.el6.x86_64.rpm
```
