...
```bash
curl -J -O http://gigaspaces-repository-eu.s3.amazonaws.com/cloudify/4.0.1/sp-release/cloudify-4.0.1~sp.el6.x86_64.rpm
sudo yum install -y cloudify-4.0.1~sp.el6.x86_64.rpm
```
