...
```bash
curl -J -O http://repository.cloudifysource.org/cloudify/4.1.0/ga-release/cloudify-4.1.0~ga.el6.x86_64.rpm
sudo yum install -y cloudify-4.1.0~ga.el6.x86_64.rpm
```
